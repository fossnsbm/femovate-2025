  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row w-full lg:gap-0 gap-4">
          ...
          {/* Left Section */}
          <div className="flex justify-center m-4 md:m-10 lg:m-20  lg:w-auto">
            <div className="flex flex-col justify-center gap-8 md:gap-12 lg:gap-4 items-end pl-0 md:pl-6 lg:pl-10 w-full">
              <div className="flex flex-col md:flex-row justify-start items-center gap-4 md:gap-10 w-full mb-6 md:mb-10">
                ...
                <div className="relative w-full max-w-[320px] md:max-w-[350px] h-[90px] md:h-[140px] rounded overflow-hidden flex justify-center">
                  <Image
                    ...
                    priority
                  />
                  <div className="absolute inset-0 z-10 flex items-center justify-center text-white text-3xl md:text-3xl font-medium select-none pointer-events-none">
                    Contact
                  </div>
                </div>
                {/* "Us" beside image */}
              ...
              <div className="text-black text-lg md:text-xl lg:text-2xl font-med leading-relaxed pl-0 md:pl-6 lg:pl-10 text-center md:text-left">
                ...
                Reach out to us — together, we can empower change and innovate
                for a brighter, more inclusive future.
              </div>
              <div className="bg-[#E6DBCE] lg:rounded-2xl flex flex-col md:flex-row justify-around items-center p-6 md:p-2  w-full h-auto md:h-32 cursor-pointer hover:bg-[#D4C2A6] transition-colors duration-300 gap-4 md:gap-0">
                ...
                <div className="relative flex-shrink-0 w-full max-w-[220px] md:max-w-[320px] lg:w-80 h-12 md:h-20 rounded overflow-hidden cursor-pointer">
                  ...
                  />
                  <a
                    href="https://chat.whatsapp.com/GY4ji4rmvA43WH8K83f4Bk"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="absolute inset-0 z-10 flex items-center justify-center text-white text-lg md:text-2xl font-bold select-none visited:text-white hover:text-white no-underline"
                  >
                    Click Here
                  </a>
                </div>
