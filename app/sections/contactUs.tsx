                ...
                <div className="flex justify-center m-4 md:m-10 lg:m-20 w-full lg:w-auto">
                    <div className="flex flex-col justify-center gap-8 md:gap-12 lg:gap-16 items-end pl-0 md:pl-6 lg:pl-10 w-full">
                        <div className="flex flex-col md:flex-row justify-start items-center gap-4 md:gap-10 w-full mb-6 md:mb-10">
                            ...
                            <div className="relative w-full max-w-[320px] md:max-w-[400px] h-[90px] md:h-[140px] rounded overflow-hidden flex justify-center">
                                <Image
                                    src="/Rectangle1.png"
                                    alt="Contact"
                                    layout="fill"
                                    ...
                                    priority
                                />
                                <div className="absolute inset-0 z-10 flex items-center justify-center text-white text-4xl md:text-7xl font-bold select-none pointer-events-none">
                                    Contact
                                </div>
                            </div>
                            {/* "Us" beside image */}
                            <div className="text-black text-4xl md:text-7xl font-bold self-center">
                                Us
                            </div>
                        </div>

                        <div className="text-black text-lg md:text-2xl lg:text-3xl font-medium leading-relaxed pl-0 md:pl-6 lg:pl-10 text-center md:text-left">
                        ...
                        <div className="bg-[#E6DBCE] lg:rounded-2xl flex flex-col md:flex-row justify-around items-center p-6 md:p-12 lg:p-24 w-full h-auto md:h-36 cursor-pointer hover:bg-[#D4C2A6] transition-colors duration-300 gap-4 md:gap-0">
                            <div className="text-black text-2xl md:text-4xl font-medium text-center">
