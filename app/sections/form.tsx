              ...
              <div className="flex justify-between pt-6">
                {step > 1 && (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-4 py-3 rounded-lg bg-gradient-to-r from-[#6B7280] to-[#4B5563] text-green-200 hover:from-[#4B5563] hover:to-[#374151] transition-all shadow-md font-medium flex items-center gap-2"
                  >
