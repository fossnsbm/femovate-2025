...
return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white text-black rounded-full shadow-lg flex items-center justify-between w-[95%] max-w-[1400px] h-16 z-50">
      {/* Container for both navigation and button with padding */}
    <div className="flex items-center justify-between w-full px-8 sm:px-12">
        {/* Left side navigation links */}
        <div className="hidden md:flex items-center" style={{ gap: '3.5rem', marginLeft: '1rem' }}>
        <a
        href="#"
      ...
      {/* Mobile Menu */}
    {menuOpen && (
        <div className="absolute top-20 left-1/2 transform -translate-x-1/2 bg-white text-black rounded-xl shadow-xl px-6 py-4 flex flex-col items-center md:hidden w-[90%] max-w-sm z-50"
        style={{ gap: '1.25rem' }}>
        <a
        href="#"
